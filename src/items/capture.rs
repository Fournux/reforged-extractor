...
use super::text::{
    clean_item_name, encoded_name_ids_from_hex, encoded_name_seeds_from_hex, is_invalid_label,
};
...
pub(super) struct PacketLogTextInputs {
    pub(super) name_ids: BTreeSet<u32>,
    pub(super) compact_seeds: BTreeMap<u32, u64>,
    pub(super) decoded_records: BTreeMap<Vec<u8>, String>,
}

pub(super) fn packet_log_text_inputs(
